...
<body style='background-image:url("<?= basePath() ?>/public/assets/images/bg/bg6.jpg")'
    class="w-full bg-no-repeat bg-cover">
        <main class="w-full ff-pri h-auto lg:h-screen py-10">
        <form id="signin" action="signin" method="post" class="w-11/12 lg:w-5/12 m-0-auto
         bgColor-sec-600 py-10">

            <div class="w-8/12 m-0-auto mb-5">
                <h2 class="py-1 color-1">Welcome Back</h2>
            ...
            <div class="w-7/12 m-0-auto fw-bold txt-h-c fs-sm pt-4 color-1">
