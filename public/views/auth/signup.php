...
<body style='background-image:url("<?= basePath() ?>/public/assets/images/bg/bg6.jpg")'
    class="w-full bg-no-repeat bg-cover">
        <main class="w-full ff-pri h-auto  py-5">
        <form id="signup_form" action="signup" method="post"
          class="w-11/12 lg:w-5/12 m-0-auto bgColor-sec-600 py-10">

            <div class="w-8/12 m-0-auto mb-5">
                <h2 class="py-1 color-pri"><?= app_name() ?></h2>
                <p class="color-1 fw-600">Register your account</p>
            </div>

            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="fullName" class="block py-2 fs-sm color-1">Full Name</label>
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="email" class="block py-2 fs-sm color-1">Email</label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="password" class="block py-2 fs-sm color-1">Password</label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
            ...
            <div class="fw-600 w-8/12 m-0-auto mb-2">
                <label for="confirmPassword" class="block py-2 fs-sm color-1">
                    Confirm Password
                </label>
                <input class="w-full py-2 px-2 rounded b-color-sec-300 border-2
                focus:b-color-pri outline-0"
            ...
            <div class="w-7/12 m-0-auto fw-bold txt-h-c fs-sm py-4 color-1">
